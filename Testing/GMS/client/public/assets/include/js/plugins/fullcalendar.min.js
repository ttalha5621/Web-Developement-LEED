        ...
        (r.prototype.renderSegHtml = function (e, r) {
          ...
          return (
            ...
            e.isStart &&
              ...
              (y = '<span class="fc-time">' + t.htmlEscape(n) + "</span>"),
            (i =
              '<span class="fc-title">' +
            ...
            '<a class="' +
              g.join(" ") +
              '"' +
              (d.url ? ' href="' + t.htmlEscape(d.url) + '"' : "") +
              (m ? ' style="' + m + '"' : "") +
              '><div class="fc-content">' +
              ("rtl" === l.dir ? i + " " + y : y + " " + i) +
              "</div>" +
              (u ? '<div class="fc-resizer fc-start-resizer"></div>' : "") +
              (f ? '<div class="fc-resizer fc-end-resizer"></div>' : "") +
              "</a>"
          );
        }),
      ...
      return (
        ...
        (r.prototype.renderSegRow = function (e, r) {
          ...
          for (n = 0; n < f; n++) {
            ...
            C && (c.isRtl ? t.appendToElement(s, C) : t.prependToElement(s, C)),
              g.appendChild(s);
          }
          return {
            row: e,
    ...
    p = (function (e) {
      ...
      return (
        ...
        (r.prototype.renderFillRow = function (e, r) {
          ...
          return (
            h && (s.isRtl ? t.appendToElement(o, h) : t.prependToElement(o, h)),
            i
          );
        }),
        r
    ...
    b = (function (e) {
      ...
      return (
        ...
        (r.prototype.updateSize = function (e) {
          ...
          (e || this.isCellSizesDirty || this.view.calendar.isEventsUpdated) &&
        ...
        (r.prototype.limitRow = function (e, r) {
          ...
          if (r && r < S.segLevels.length) {
            for (
              n = S.segLevels[r - 1],
                i = S.cellMatrix,
                (o = t.findChildren(S.tbodyEl).slice(r)).forEach(function (e) {
            ...
            l.addEventListener("click", function (t) {
              ...
              "function" == typeof l &&
                ...
                "popover" === l
                  ...
                  : "string" == typeof l && o.calendar.zoomTo(d, l);
            }),
            l
          );
        }),
            ...
            (l = {
              ...
              content: function (t) {
                (a.segPopoverTile = new u(a.context, t)),
                  a.updateSegPopoverTile(a.props.cells[e][p].date, i);
              },
              hide: function () {
            ...
            return s.colWeekNumbersVisible
              ? '<td class="fc-week-number" ' +
                  ...
                  t.buildGotoAnchorHtml(
                    s,
                    { date: i, type: "week", forceOff: 1 === r.colCnt },
                    n.format(i, w)
                  ) +
                  "</td>"
              : "";
  ...
  var C = (function (e) {
      function t(t, r) {
        ...
        return (
          (n.slicer = new E()),
          (n.dayGrid = r),
          t.calendar.registerInteractiveComponent(n, { el: n.dayGrid.el }),
          n
        );
      }
      return (
        ...
        (t.prototype.render = function (e) {
          var t = this.dayGrid,
            ...
            n = e.dayTable;
          t.receiveProps(
            i({}, this.slicer.sliceProps(e, r, e.nextDayThreshold, t, n), {
              dateProfile: r,
              cells: n.cells,
              isRigid: e.isRigid,
            })
    ...
    D = (function (e) {
      function n(n) {
        ...
        (r.dragSelection = null),
          (r.handlePointerDown = function (e) {
            var t = r,
              ...
              i = t.dragging,
              o =
                n.opt("selectable") && n.isValidDateDownEl(e.origEvent.target);
            i.setIgnoreMove(!o),
              (i.delay = e.isTouch
                ? (function (e) {
        ...
        (a.touchScrollAllowed = !1),
          (a.minDistance = o.opt("selectMinDistance") || 0),
          (a.autoScroller.isEnabled = o.opt("dragScroll"));
    ...
    function n(r) {
      ...
      (o.subjectSeg = null),
        ...
        (o.handlePointerDown = function (e) {
          ...
          (o.relevantEvents = t.getRelevantEvents(s.state.eventStore, d)),
            (a.minDistance = e.isTouch ? 0 : i.opt("eventDragMinDistance")),
            (a.delay =
              e.isTouch && d !== i.props.eventSelection
                ...
                : null),
            (l.parentNode = s.el),
            (l.revertDuration = i.opt("dragRevertDuration"));
        ...
        (o.handleDragStart = function (e) {
          ...
          e.isTouch
            ? i !== o.component.props.eventSelection &&
              n.dispatch({ type: "SELECT_EVENT", eventInstanceId: i })
            ...
            if (e) {
              ...
              (u.opt("editable") && u.opt("droppable"))
                ? (s = (function (e, n, r) {
                    ...
                    i.allDay !== o.allDay &&
                      ((s.allDay = o.allDay),
                      (s.hasEnd = n.component.opt("allDayMaintainDuration")),
                      o.allDay && (a = t.startOfDay(a)));
                    var c = t.diffDates(
                      a,
                      l,
                      e.component.dateEnv,
                      e.component === n.component ? e.component.largeUnit : null
                    );
            ...
            if (
              ...
              if (l === n) {
                ...
                for (
                  var v = {},
                    f = 0,
                    E = n.pluginSystem.hooks.eventDropTransformers;
                  f < E.length;
                  f++
                ) {
                  var m = E[f];
                ...
                var S = i({}, v, {
                  ...
                  event: new t.EventApi(
                    n,
                    h.defs[c.defId],
                    d ? h.instances[d.instanceId] : null
                  ),
                  revert: function () {
                ...
                n.publiclyTrigger("eventLeave", [
                  { draggedEl: e.subjectEl, event: g, view: r },
                ]),
                  n.dispatch({
                ...
                var y = i({}, l.buildDatePointApi(p.dateSpan), {
                  draggedEl: e.subjectEl,
                  jsEvent: e.origEvent,
                  view: p.component,
                });
                l.publiclyTrigger("drop", [y]),
      ...
      (l.pointer.selector = n.SELECTOR),
        ...
        (l.autoScroller.isEnabled = a.opt("dragScroll"));
      ...
      (r.draggingSeg = null),
        ...
        (r.handleDragEnd = function (e) {
          ...
          n.publiclyTrigger("eventResizeStop", [
            { el: r.draggingSeg.el, event: l, jsEvent: e.origEvent, view: i },
          ]),
            r.validMutation
              ? (n.dispatch({ type: "MERGE_EVENTS", eventStore: c }),
                n.publiclyTrigger("eventResize", [
                  {
                    ...
                    event: new t.EventApi(
                      n,
                      c.defs[o.defId],
                      a ? c.instances[a.instanceId] : null
                    ),
                    revert: function () {
