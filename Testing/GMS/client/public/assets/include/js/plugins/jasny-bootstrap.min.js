        ...
        (b.prototype.slide = function (b, c, d) {
          ...
          b.each(function () {
            "auto" !== a(this).css(f) &&
              ...
              "auto" !== a(this).css(g) &&
                a(this).css(g, (parseInt(a(this).css(g), 10) || 0) - c);
          }),
            this.$element
        ...
        (b.prototype.disableScrolling = function () {
          ...
          if (
            (void 0 === a("body").data("offcanvas-style") &&
              a("body").data("offcanvas-style", a("body").attr("style") || ""),
              ...
              -1 !== c.index(this.$element) &&
                ...
                c.addClass("canvas-sliding").each(function () {
                  void 0 === a(this).data("offcanvas-style") &&
                    ...
                    ("auto" !== a(this).css(d) && "0px" !== a(this).css(d)) ||
                      ("auto" !== a(this).css(e) && "0px" !== a(this).css(e)) ||
                      a(this).css(d, 0);
                }),
                ...
                e = function () {
                  "slide-out" == this.state &&
                    ...
                    c
                      ...
                      .each(function () {
                        a(this)
                          .attr("style", a(this).data("offcanvas-style"))
        ...
        a(document).on(
          ...
          function (b) {
            if (0 === a(b.target).closest(".rowlink-skip").length) {
              var c = a(this);
              c.data("bs.rowlink") ||
                (c.rowlink(c.data()), a(b.target).trigger("click.bs.rowlink"));
            }
          }
        );
    })(window.jQuery),
    +(function (a) {
      ...
      (e.DEFAULTS = {
              ...
              a.proxy(function () {
                return a
                  .map(this.buffer, function (a, b) {
                    return this.tests[b] && a != this.options.placeholder
                      ? a
                      : null;
                  })
                  .join("");
        ...
        (e.prototype.listen = function () {
          if (!this.$element.attr("readonly")) {
            ...
            this.$element
              ...
              .on("focus.bs.inputmask", a.proxy(this.focusEvent, this))
              .on("blur.bs.inputmask", a.proxy(this.blurEvent, this))
              .on("keydown.bs.inputmask", a.proxy(this.keydownEvent, this))
              .on("keypress.bs.inputmask", a.proxy(this.keypressEvent, this))
        ...
        (e.prototype.shiftR = function (a) {
          for (
            var b = this.mask.length, c = a, d = this.options.placeholder;
            b > c;
            c++
          )
            if (this.tests[c]) {
        ...
        (e.prototype.keydownEvent = function (a) {
          ...
          if (8 == c || 46 == c || (b && 127 == c)) {
            ...
            return (
              f - e === 0 &&
                ((e = 46 != c ? this.seekPrev(e) : (f = this.seekNext(e - 1))),
          ...
          return (
            !a && d + 1 < this.partialPosition
              ...
              : (a || d + 1 >= this.partialPosition) &&
                (this.writeBuffer(),
                a ||
                  this.$element.val(this.$element.val().substring(0, d + 1))),
          ...
          if (
            ...
            (this.name = this.$input.attr("name") || c.name),
              ...
              0 === this.$hidden.length &&
                (this.$hidden = a('<input type="hidden">').insertBefore(
                  this.$input
                )),
        ...
        a(document).on(
          ...
          function (b) {
            ...
            if (!c.data("bs.fileinput")) {
              ...
              d.length > 0 &&
                (b.preventDefault(), d.trigger("click.bs.fileinput"));
            }
          }
        );
    })(window.jQuery);
