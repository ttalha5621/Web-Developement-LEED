(function (h) {
  ...
  n.ext = x = {
    ...
    classes: {},
    build:
      "bs4/dt-1.10.18/cr-1.5.0/fc-3.2.5/fh-3.1.4/r-2.2.2/rg-1.1.0/rr-1.2.4/sc-1.5.0/sl-1.2.6",
    errMode: "alert",
    feature: [],
    search: [],
...
(function (e) {
  ...
  e.extend(i.prototype, {
    ...
    _fnRegions: function () {
      ...
      this.s.aoTargets.push({ x: e(this.s.dt.nTable).offset().left, to: 0 });
      for (
    ...
    _fnCreateDragNode: function () {
      ...
      this.dom.drag = e(g.cloneNode(!1))
        ...
        .append(e(f.cloneNode(!1)).append(e(c.cloneNode(!1)).append(d[0])))
        .css({
          position: "absolute",
          top: 0,
          left: 0,
        ...
        (this.c.header &&
          ((f =
            !c.visible || b <= c.theadTop - this.c.headerOffset
              ? "in-place"
              : b <= c.tfootTop - c.theadHeight - this.c.headerOffset
              ? "in"
              : "below"),
...
$jscomp.findInternal = function (a, d, c) {
  ...
  for (var e = a.length, f = 0; f < e; f++) {
    var h = a[f];
    if (d.call(c, h, f, a)) return { i: f, v: h };
  }
  return { i: -1, v: void 0 };
};
$jscomp.ASSUME_ES5 = !1;
...
(function (a) {
  ...
  a.extend(h.prototype, {
    ...
    _group: function (b, g) {
      for (
        var c = a.isArray(this.c.dataSrc) ? this.c.dataSrc : [this.c.dataSrc],
          d = f.ext.oApi._fnGetObjectDataFn(c[b]),
          h = this.s.dt,
          l,
          n,
          m = [],
        ...
        if (n === e || l !== n) m.push({ dataPoint: l, rows: [] }), (n = l);
    ...
    _groupDisplay: function (b, a) {
      for (var c = this.s.dt, g, d = 0, f = a.length; d < f; d++) {
        var e = a[d],
          ...
          k = e.rows;
        this.c.startRender &&
          ((g = this.c.startRender.call(this, c.rows(k), h, b)),
          (g = this._rowWrap(g, this.c.startClassName, b)) &&
            g.insertBefore(c.row(k[0]).node()));
        this.c.endRender &&
          ((g = this.c.endRender.call(this, c.rows(k), h, b)),
          (g = this._rowWrap(g, this.c.endClassName, b)) &&
            g.insertAfter(c.row(k[k.length - 1]).node()));
    ...
    _rowWrap: function (b, g, c) {
      ...
      return b === e
        ...
        : ("object" === typeof b &&
          b.nodeName &&
          "tr" === b.nodeName.toLowerCase()
            ? a(b)
            : b instanceof a && b.length && "tr" === b[0].nodeName.toLowerCase()
            ? b
            : a("<tr/>").append(
                a("<td/>").attr("colspan", this._colspan()).append(b)
              )
          )
            .addClass(this.c.className)
            .addClass(g)
            .addClass("dtrg-level-" + c);
    },
  });
  h.defaults = {
  ...
  a(c).on("preInit.dt.dtrg", function (b, c, d) {
    "dt" === b.namespace &&
      ((b = c.oInit.rowGroup), (d = f.defaults.rowGroup), b || d) &&
      ((d = a.extend({}, d, b)), !1 !== b && new h(c, d));
  });
  return h;
});
...
(function (e) {
  ...
  e.extend(g.prototype, {
        ...
        if (this.s.dt.bFiltered || this.s.dt.bSorted) this.s.lastScrollTop = 0;
          ...
          if (
            ...
            0 >= d
              ...
              ? ((d = this.s.dt.fnRecordsDisplay() - this.s.dt._iDisplayLength),
                0 > d && (d = 0))
              : 0 !== d % 2 && d++;
            if (
    ...
    _parseHeight: function (a) {
      ...
      "px" === c
        ...
        : "em" === c && (b = a * parseFloat(e("body").css("font-size")));
      return b ? b : 0;
    },
    ...
    _fnInfo: function () {
      if (this.s.dt.oFeatures.bInfo) {
        var a = this.s.dt,
          ...
          g = a.fnRecordsDisplay(),
          c = Math.ceil(
            this.fnPixelsToRow(c + this.s.heights.viewport, !1, this.s.ani)
          ),
          c = g < c ? g : c,
  ...
  k.register(["scroller().scrollToRow()", "scroller.toPosition()"], function (
    a,
    b
  ) {
    this.iterator("table", function (c) {
  ...
  function x(a) {
    ...
    c.on("mousedown.dtSelect", d, function (b) {
      ...
      .on("click.dtSelect", d, function (b) {
        ...
        if (
          e(b.target).closest("div." + g)[0] == a.table().container() &&
          ...
          h.isDefaultPrevented() ||
            ...
            "row" === c
              ...
              : "cell" === c && ((c = g.index()), r(b, a, d, "cell", c)),
